...
//-----------------------------------------------------------------------------------------------
template<typename T>
EPropertyGetResult QuNamedProperties::Get(const QuString& name, T& outDatum) const
{
...
//-----------------------------------------------------------------------------------------------
template<typename T>
void QuNamedProperties::Set(const QuString& name, const T& datum)
{
	auto propertyIter = m_properties.find(name);
	if (propertyIter == m_properties.end())
	{
